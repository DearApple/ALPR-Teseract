...
#imagePaths = sorted(list(paths.list_images("C:\\Users\\DearA\\OneDrive\\Pulpit\\VS_Code\\images\\Cars3.png")))
...
for imagePath in imagePaths:
    ...
    (lpText, lpCnt) = PyImageSearchANPR().find_and_ocr(image, psm=args["psm"],
